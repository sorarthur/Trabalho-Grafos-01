    ...
    public:
        ...
        void countCycles() {
            ...
            do {
                ...
                for (int i = 0; i < vertex - 1; i++) {
                    if (!hasEdge(vertices[i], vertices[i + 1])) { // Verifica se há uma aresta entre vértices consecutivos
                        verify = false;
                        i = vertex; // Se não houver aresta, a permutação não forma um caminho válido
                    }
                }
                ...
                if (verify) {
                    for (int i = 2; i < vertex; i++) {
                        if (hasEdge(vertices[i], vertices[0])) { // Verifica se o último vértice está conectado ao primeiro
            ...
            // Imprime o número total de ciclos encontrados e o tempo de execução
    ...
    int main() {
        ...
        g.print();
        // Conta e imprime os ciclos no grafo
        g.countCycles();
        return 0;
    }